...
Governed controlled-growth batch adding start-here navigation, maturity model, field notes, pruning policy, and validation profiles.
...
## Notes
Controlled-growth batch added START_HERE, maturity model, field notes, pruning policy, and validation profiles while keeping capability growth documentation-only.
