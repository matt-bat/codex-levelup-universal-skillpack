# Governance Artifact: SKILLPACK-ARCHITECTURE-V2-PUSH-20260717

- `schema_version`: 2
- `created_at_utc`: 2026-07-18T02:11:33.967426+00:00
...
- [x] `scripted-command-execution` (status: pass)
  - evidence: fetched and verified zero divergence from `origin/main`; operation is a normal non-force push with post-push remote-ref verification
  - waiver_reason:
- [x] `regression-prevention` (status: pass)
  - evidence: 102 unit tests, 25 routing scenarios, 31 skill checks, policy/order/catalog/schema/YAML/compilation/workflow checks passed
  - waiver_reason:
- [x] `doc-maintenance` (status: pass)
  - evidence: branch-push versus release metadata synchronized; 101 Markdown files and 207 relative links passed
  - waiver_reason:
...
Governance and ordering constrain the external Git operation; documentation keeps release metadata accurate; the tracker recordability gate prevents a transient push permission from becoming a permanent directive; deterministic execution, regression evidence, and enforcement bind validation to the exact candidate commit.
...
- [x] mode + score: standard mode, total score 9
- [x] impact map: source policy, executable routing, governance tooling, generated views, documentation, CI workflow, and Git branch metadata
- [x] validation scope by layer: skill format, unit, fixture, schema, policy, generated-view, workflow, documentation-link, history-integrity, and diff checks
- [x] residual risks: remote CI and branch protection are observable only after push; the branch push remains distinct from a release

## Break Glass
- enabled: false

## Notes
User authorized a normal non-force push to origin/main on 2026-07-17. Local-only describes build and validation scope; the separately authorized external operation is limited to this Git branch push. No tag, hosted release, deployment, force push, or remote-settings change is authorized. Target identity and zero divergence were verified after fetching origin/main. Rollback is a new revert commit followed by a normal push.

## Change Binding
- `base_sha`: 9ef4b74604af601322d3616b85d408be8fec4c5f
- `manifest_sha256`: a86588294e07319bf553d66793f19949e235994e0b0a4493371e3a9b1fe16d67
- `manifest`:
  ...
  - `M` `docs/project-index.md` (`sha256`: 5f7c7c22a3e183be9448f4ccd05d57d873a82b832bfa57e05632d38c411ad7c7)
  - `M` `skills/.gitignore` (`sha256`: 73cef5fec3e121bc61d3561a03b73cc2cab091efede309c122a5f809299c5545)
  - `M` `skills/CHANGELOG.md` (`sha256`: 27f367597a17e47a325ef15ad36bf07a9e346de0098b99d62b97636e3d2e84a8)
  ...
  - `M` `skills/docs/known-limitations.md` (`sha256`: 1daa3e023c3680e116e6268ed41e01b378c362ab042d680916357ca72ecf879a)
  ...
  - `A` `skills/docs/release-provenance.md` (`sha256`: 46a358c27743cc24c7ce51521077fea2e242ce7ef9239c5a216afea2ee2c8f32)
  ...
  - `M` `skills/skill-governance/scripts/generate_governance_artifact.py` (`sha256`: 0db5a7f4aac2322a87f96d01bbc8f440a4862cc8dbf16e1f94e2d3ce98095507)
  ...
  - `M` `skills/skill-governance/tests/test_generate_governance_startup.py` (`sha256`: 354affda6878cce23f0ac47e6d76a2bd370339711dd248ab94227254104b595a)
